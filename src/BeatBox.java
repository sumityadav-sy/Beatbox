...
public static void main(String[] args) {
    ...
    String name;
    System.out.println("enter your live cha name :");
    name = obj.nextLine();
    ...
    // if args provided: java BeatBox <host> <port>
    if (args.length >= 1) host = args[0];
    if (args.length >= 2) port = Integer.parseInt(args[1]);
    new BeatBox().startUp(name,host,port);
  }
  public void startUp(String name ,String host ,int port ) {
    userName = name;
  ...
  public void buildGUI() {
    ...
    JButton save = new JButton("Save current pattern");
    ...
    rset.addActionListener(e-> reset());
    buttonBox.add(rset); 
    ...
    private void writeFile() {
      ...
      fs.showSaveDialog(frame);
       try (ObjectOutputStream os = 
         new ObjectOutputStream(new FileOutputStream(fs.getSelectedFile()))) {
